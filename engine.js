...
function draw(gl, viewProjectionMatrix, programInfo, deltaTime){
    ...
    rail_1.drawCube(gl, viewProjectionMatrix, programInfo, deltaTime);
    rail_2.drawCube(gl, viewProjectionMatrix, programInfo, deltaTime);
    rail_3.drawCube(gl, viewProjectionMatrix, programInfo, deltaTime);
    train.drawCube(gl, viewProjectionMatrix, programInfo, deltaTime);
    wall_1.drawCube(gl, viewProjectionMatrix, programInfo, deltaTime);
    wall_2.drawCube(gl, viewProjectionMatrix, programInfo, deltaTime);
